                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="/orders/create"
                                    class="red">สร้างรายการขายสินค้า</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <tbody id="product_body">
                                                @foreach ($order->products as $item)
                                                    <tr>
                                                        <td class="action">
                                                            @if($loop->index > 0)
                                                                <a href='#' onclick='removeRow(this)' class='btn btn-danger btn-circle btn-sm d-inline-flex align-items-center justify-content-center'><i class='fa fa-trash'></i></a>
                                                            @endif
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="number" name="quantities[]" class="form-control"value="{{ $item->pivot->quantity }}" />
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
